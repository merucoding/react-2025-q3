...
class Header extends reactExports.Component {
  render() {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-logo text-4xl bg-linear-to-r from-pink-500 to-violet-500 bg-clip-text text-transparent", children: "Pokemon Search" }) });
  }
}
class Card extends reactExports.Component {
  render() {
    const { pokemon } = this.props;
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 flex flex-col items-center gap-y-2 aspect-square w-[200px] border-1 border-solid border-fuchsia-300 rounded-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[100px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: pokemon.sprites.front_default, alt: "picture" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-fuchsia-400 font-bold text-lg", children: pokemon.name }),
...
class CardList extends reactExports.Component {
  render() {
    const { pokemons } = this.props;
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 flex gap-4 flex-wrap justify-center", children: pokemons.map((pokemon, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { pokemon }, index)) });
  }
}
class ErrorButton extends reactExports.Component {
  state = {
    showError: false
  };
  render() {
...
class TopControls extends reactExports.Component {
  state = {
  ...
  render() {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center gap-x-4 mt-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorButton, {})
    ] });
  }
}
class Loading extends reactExports.Component {
  render() {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center items-center h-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 border-4 border-fuchsia-300 border-t-transparent rounded-full animate-spin" }) });
  }
}
const borderStyles = "px-2 py-2 border-1 border-solid border-fuchsia-300 rounded-xl cursor-pointer";
function isPokemonListResponse(data) {
  return typeof data === "object" && data !== null && "results" in data && Array.isArray(data.results);
}
class Main extends reactExports.Component {
  state = {
    loading: false,
    pokemons: [],
  ...
  render() {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "font-lexend-exa text-emerald-500 font-light", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TopControls, { onSearch: this.handleSearch }),
      loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Loading, {}) : errorMessage ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 text-fuchsia-400 font-bold text-lg", children: errorMessage }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CardList, { pokemons })
    ] });
  }
}
class ErrorBoundary extends reactExports.Component {
  ...
  render() {
    if (this.state.hasError) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center items-center h-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-lexend-exa text-fuchsia-400 font-bold text-2xl", children: "Something went wrong.." }) });
    }
...
//# sourceMappingURL=index-qBZ2OCAF.js.map
